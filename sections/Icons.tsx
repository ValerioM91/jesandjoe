...
type TIcons = { title?: string; icons?: IconProps[]; background: "white" | "green" }

const Icons = ({ title, icons, background = "white" }: TIcons) => {
  ...
  return (
    <section className={`p mt-16 ${colors.background}`}>
      <div className={`container mx-auto max-w-3xl px-4 ${background === "green" ? "py-4 md:py-8 lg:py-16" : ""}`}>
        {title && (
